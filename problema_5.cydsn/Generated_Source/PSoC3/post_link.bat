...
CD /D "C:\Keil\UV4"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
IF NOT EXIST "C:\Users\Andreea\OneDrive\Desktop\ASDN\problema_5.cydsn\problema_5.svd" rem "C:\Users\Andreea\OneDrive\Desktop\ASDN\problema_5.cydsn\problema_5.sfr"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
