...
module top ;
    ...
    begin : mux_1
        reg  tmp__mux_1_reg;
        always @(Net_20 or Net_20 or Net_20 or Net_27 or Net_27 or Net_20 or Net_27 or Net_27 or Net_30)
        begin
            case (Net_30[2:0])
                3'b000 :  tmp__mux_1_reg = Net_20;
                3'b001 :  tmp__mux_1_reg = Net_20;
                3'b010 :  tmp__mux_1_reg = Net_20;
                3'b011 :  tmp__mux_1_reg = Net_27;
                3'b100 :  tmp__mux_1_reg = Net_27;
                3'b101 :  tmp__mux_1_reg = Net_20;
                3'b110 :  tmp__mux_1_reg = Net_27;
                3'b111 :  tmp__mux_1_reg = Net_27;
            endcase
        end
        assign Net_7 = tmp__mux_1_reg;
    end
    // -- Mux end --
